...
>
	<h1 class="text-white text-center display-1">Hours from Oxygen</h1>
	<p class="text-white fw-light text-center">
		This is an example of the 2026 <a
			class="text-light"
			href="https://github.com/jrue/multimedia-template-2026"
			target="_blank">multimedia template</a
		>
		using Svelte.<br /> This topper (header) is hard coded in <code>+page.svelte</code> file, while
		the rest of the page is imported from a
		<a
			class="text-light"
			href="https://docs.google.com/document/d/1JaxRkCqZyeWIPwXXocAwUoFaPsqULiQI_Oiby_F0JZ8/edit?usp=sharing"
...
<footer class="container-fluid bg-dark text-white p-5">
	<p class="text-center">
		See template on <a
			class="text-white"
			href="https://github.com/alariosjx/hours-from-oxygen"
